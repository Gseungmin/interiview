...
common_more = [
    {
        "input": "특정 상황에 요청이 몰린다고 하셨는데 단일 인스턴스 환경인가요?",
        "answer": "네 단일인스턴스 환경입니다"
    },
    {
        "input": "락으로 인한 성능저하가 발생한다고 하셨는데, 일관성이 많이 중요할까요? 조회수와 같이 일관성이 크게 중요한 경우가 아니라면 캐시를 이용한 동기화를 고려해볼 수 있을 것 같습니다",
        "answer": "일관성이 그렇게 중요하지 않아요"
    },
]
...
common_none = [
    {
        "input": "잘 모르겠습니다.",
        "answer": "이 시나리오에서 발생할 수 있는 동시성 충돌은 무엇일까요?"
    },
]